    ...
    >
      ...
      >
        ...
        <div className="modal-content-scroll">
          ...
          {caseStudy.stats && (
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '1rem' }}>
              {caseStudy.stats.map((s, idx) => (
                <div key={idx} style={{ background: '#111111', padding: '1rem', borderRadius: 'var(--radius-md)', border: '1px solid rgba(255,255,255,0.08)', textAlign: 'center' }}>
                  <div style={{ fontSize: '0.75rem', color: 'var(--color-gray-400)', fontFamily: 'var(--font-mono)', marginBottom: '0.25rem' }}>
                    {s.label}
                  </div>
          ...
          <div className="modal-grid-2col">
            <div className="case-card">
              <div className="case-card-title">
                <AlertCircle size={18} style={{ color: '#CCCCCC' }} />
                <span>The Problem</span>
              </div>
              <p style={{ fontSize: '0.875rem', color: 'var(--color-gray-400)', lineHeight: 1.6 }}>
                {caseStudy.problem}
              </p>
            </div>
          ...
          <div className="case-card">
            <div className="case-card-title" style={{ color: '#FFFFFF' }}>
              <Cpu size={18} />
            ...
            <ul style={{ listStyle: 'none', display: 'flex', flexDirection: 'column', gap: '0.5rem', marginTop: '0.5rem' }}>
              {caseStudy.architecture.map((item, idx) => (
                <li key={idx} style={{ fontSize: '0.875rem', color: 'var(--color-text-body)', display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
                  <span style={{ color: '#FFFFFF', fontFamily: 'var(--font-mono)' }}>→</span>
                  <span>{item}</span>
                </li>
              ))}
            </ul>
          ...
          <div className="modal-grid-2col">
            <div className="case-card">
              <div className="case-card-title" style={{ color: '#E5E5E5' }}>
